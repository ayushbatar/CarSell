        ...
        <div class="container">
            ...
            <div class="car-details-content">
                <div class="car-images-and-description">
                    <div class="car-images-carousel">
                        <div class="car-image-wrapper">
                            <img class="car-active-image" id="activeImage" src="/img/cars/Lexus-RX200t-2016/1.jpeg"
                                alt="" />
                        </div>
                        ...
                        <button class="carousel-button prev-button" id="prevButton">
                            <svg style="width: 64px" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="card car-detailed-description">
                        ...
                        <ul class="car-specifications">
                            <li>
                                <svg style="color: rgb(0, 192, 102)" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li>
                                <svg style="color: red" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="currentColor">
                                    <path fill-rule="evenodd"
                ...
                <div class="car-details card">
                    ...
                    <div class="my-medium flex gap-1">
                        <img class="car-details-owner-image" src="/img/avatar.png" alt="" />
                        <div>
                            <h3 class="car-details-owner">John Smith</h3>
                            <div class="text-muted">5 cars</div>
                        </div>
                    </div>
                    <a class="car-details-phone" href="tel:+995557123***">
                        <svg style="width: 16px" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
