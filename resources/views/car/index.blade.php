                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img class="my-cars-img-thumbnail" src="/img/cars/Lexus-RX200t-2016/1.jpeg"
                                            alt="" />
                                    </td>
                                    ...
                                    <td>Yes</td>
                                    <td class="">
                                        <a class="btn btn-edit inline-flex items-center" href="edit_car.html">
                                            <svg style="width: 12px; margin-right: 5px"
                                        ...
                                        <a class="btn btn-edit inline-flex items-center" href="car_images.html">
                                            <svg style="width: 12px; margin-right: 5px"
                                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round"
