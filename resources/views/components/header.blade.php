<header class="navbar">
    <div class="navbar-content container">
        ...
        <div class="navbar-auth">
            <a class="btn btn-add-new-car" href="{{ route("car.create") }}">
                <svg style="width: 18px; margin-right: 4px" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <div class="navbar-menu" tabindex="-1">
                <a class="navbar-menu-handler" href="javascript:void(0)">
                    My Account
            ...
            <a class="btn btn-primary btn-signup" href="{{ route("signup") }}">
                <svg style="width: 18px; margin-right: 4px" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a class="btn btn-login flex items-center" href="{{ route("login") }}">
